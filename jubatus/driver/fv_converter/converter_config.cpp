...
#include "jubatus/core/fv_converter/except_match.hpp"
...
#include "jubatus/core/fv_converter/num_feature_impl.hpp"
#include "jubatus/core/fv_converter/num_filter.hpp"
#include "jubatus/core/fv_converter/space_splitter.hpp"
#include "jubatus/core/fv_converter/string_filter.hpp"
#include "jubatus/core/fv_converter/without_split.hpp"
...
using jubatus::core::fv_converter::except_match;
using jubatus::core::fv_converter::without_split;
...
using jubatus::core::fv_converter::space_splitter;
using jubatus::core::fv_converter::splitter_weight_type;
using jubatus::core::fv_converter::datum_to_fv_converter;
using jubatus::core::fv_converter::num_value_feature;
using jubatus::core::fv_converter::num_log_feature;
using jubatus::core::fv_converter::num_string_feature;
using jubatus::core::fv_converter::word_splitter;
using jubatus::core::fv_converter::frequency_weight_type;
using jubatus::core::fv_converter::term_weight_type;
using jubatus::core::fv_converter::FREQ_BINARY;
using jubatus::core::fv_converter::TERM_FREQUENCY;
using jubatus::core::fv_converter::TERM_BINARY;
using jubatus::core::fv_converter::LOG_TERM_FREQUENCY;
using jubatus::core::fv_converter::WITH_WEIGHT_FILE;
using jubatus::core::fv_converter::IDF;
...
pfi::lang::shared_ptr<datum_to_fv_converter> make_fv_converter(
  ...
  try {
    ...
    std::string msg = std::string("Unexpected end of string is detected: ")
        + e.what();
    throw JUBATUS_EXCEPTION(converter_exception(msg.c_str()));
  ...
  initialize_converter(c, *converter);
  return converter;
}
