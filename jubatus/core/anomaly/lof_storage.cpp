...
namespace {
void mark_removed(lof_entry& entry) {
  entry.kdist = -1;
}

bool is_removed(const lof_entry& entry) {
...
void lof_storage::put_diff(const lof_table_t& mixed_diff) {
...
void lof_storage::mix(const lof_table_t& lhs, lof_table_t& mixed) const {
